...
public class ModBlocks {
    ...
    public static void init() {
        OrePhos = new BlockOre("orephosphophyllite",Material.ROCK, SimplyGems.phosphophyllite, 1, 3 ).setHardness(2f).setResistance(5f).setCreativeTab(GemsCreativeTab.creativeTab);
